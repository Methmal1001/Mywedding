...
if (isset($_POST['user_update'])) {
    ...
    if ($result_update) {
        ...
        echo "<script>window.location.href='profile.php';</script>";  // Redirect to profile or desired page
    } else {
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="form-outline mb-4">
            <input type="text" class="form-control w-50 m-auto" 
                   name="user_username" 
                   value="<?php echo isset($user_username) ? $user_username : ''; ?>" required>
        </div>
        <div class="form-outline mb-4">
        ...
        <div class="form-outline mb-4">
            <input type="text" class="form-control w-50 m-auto" 
                   name="user_address" 
                   value="<?php echo isset($user_address) ? $user_address : ''; ?>" required>
        </div>
        <div class="form-outline mb-4">
            <input type="text" class="form-control w-50 m-auto" 
                   name="user_mobile" 
                   value="<?php echo isset($user_mobile) ? $user_mobile : ''; ?>" required>
        </div>
