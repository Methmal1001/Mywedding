...
<head>
    ...
    <script>
        function validatePassword() {
            ...
            // Password validation: At least 8 characters, 1 digit, 1 lowercase, 1 uppercase, and 1 special character
            ...
            <div class="col-lg-12 col-xl-6">
                <form action="" method="post" enctype="multipart/form-data" onsubmit="return validatePassword();">
                    ...
                    <div class="mt-4 pt-2">
                        ...
                        <p class="small fw-bold mt-2 pt-1 mb-0" style="font-size: 16px;">Already have an account? 
                            <a href="user_login.php" class="text-info" style="font-size: 18px;">Login</a>
                        </p>
                    </div>
                </form>
            </div>
        ...
        if ($user_password != $conf_user_password) {
            ...
            if ($result) {
                ...
                if ($rows_count > 0) {
                    ...
                    // Insert user data with login_status = 0
                    $insert_query = "INSERT INTO user_table 
                        (username, user_email, user_password, user_ip, user_address, user_mobile, login_status) 
                        VALUES 
                        ('$user_username', '$user_email', '$hash_password', '$user_ip', '$user_address', '$user_contact', 0)";
            ...
            // Check for items in the user's cart
